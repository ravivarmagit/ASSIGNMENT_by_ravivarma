...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public DataSource getDataSource() {
		...
		String username = "Agnes";
		String password = "peach";
	...
	public void insert(Employee e) {
		// TODO Auto-generated method stub
		Object[] arg = { e.getempname(), e.getempdept(), e.getempdesignation(), e.getempsalary() };
		String sql = "INSERT INTO employeedetails(empname,empdept,empdesignation,empsalary) values (?,?,?,?)";
		jdbc.update(sql, arg);
